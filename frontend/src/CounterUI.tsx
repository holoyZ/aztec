...
export type Status = "disconnected" | "connected" | "deployed";

type CounterContractInstance = {
...
export function CounterUI() {
  ...
  const [counterContract, setCounterContract] = useState<CounterContractInstance | null>(null);
